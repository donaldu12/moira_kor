...
public class Resource {
    ...
    static public final String NUMBER = "1.60 Kor";
    ...
    static public final String KOREAN_SUFFIX = "_k.";
...
//                : TRADITIONAL_SUFFIX;
        String lang_suffix = simplified ? KOREAN_SUFFIX
                : TRADITIONAL_SUFFIX;
    ...
    static public String[] getFontArray(String font_check)
    {
        ...
        for (int i = 0; i < font_array.length; i++) {
            if (font_array[i].canDisplayUpTo(font_check) < 0
            	...
            	if(font_array[i].getFontName().contains("MingLiU")) {
            		size++;
            	}
            }
        }
